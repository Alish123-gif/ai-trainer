          ...
          <div className="p-8 text-center">
            ...
            <div className="flex items-center justify-center gap-16 mt-10 font-mono">
              <div className="flex flex-col items-center">
                <p className="text-3xl text-primary">xxx+</p>
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-background/70">
                ...
                <div className="text-sm text-muted-foreground">
                  {program.fitnessLevel.toUpperCase()}
                </div>
              </div>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground flex items-center gap-2 mt-1">
                      ...
                      {program.age}y • {program.workoutDays}d/week
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="px-5">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center">
                        <h3 className="font-medium text-foreground">
                          {program.workoutPlan.title}
                        </h3>
                      </div>
                      <p className="text-sm text-muted-foreground mt-1">
                        {program.equipmentAccess}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-5 pt-5 border-t border-border">
                  <div className="text-sm text-muted-foreground">
                    ...
                    {program.workoutPlan.description.substring(0, 120)}...
                  </div>
                </div>
              </CardContent>
